...
export const RESET_CHECK_CODE_STATUS = 'RESET_CHECK_CODE_STATUS';
export const CHECK_CODE_STATUS = 'CHECK_CODE_STATUS';
export const CHARGE_CONFIG = 'CHARGE_CONFIG';
export const RESET_STATUS_CHARGE_CONFIG = 'RESET_STATUS_CHARGE_CONFIG';
export const LIST_CURRENCY = 'LIST_CURRENCY';
export const RESET_STATUS_LIST_CURRENCY = 'RESET_STATUS_LIST_CURRENCY';